...
<div id="content" class="static">
  ...
  <ul>
      <li>Updates to support version 5.0 of the ALM API</li>
  ...
  <ul>
      <li>Addition of Editorial Board Knowledge Base messaging on a series of account confirmation pages</li>
  </ul>
  ...
  <ul>
      <li>Improvements to user registration confirmation messaging</li>
  </ul>
  ...
  <ul>
      ...
      <li>Auto login of users after clicking on email verification link</li>
  </ul>
